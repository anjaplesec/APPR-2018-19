...
model1 <- model1 + geom_point(data=napoved1, aes(x=leta, y=stevilo), color="red") + 
...
model2 <- model2 + geom_point(data=napoved2, aes(x=leta, y=stevilo), color="red") +
...
model3 <- model3 + geom_point(data=napoved3, aes(x=leta, y=stevilo), color="red") +
  scale_x_continuous(breaks =  seq(2008,2022, 3))
...
model4 <- model4 + geom_point(data=napoved4, aes(x=leta, y=stevilo), color="red") +
  scale_x_continuous(breaks =  seq(2008,2022, 3))
...
model5 <- model5 + geom_point(data=napoved5, aes(x=leta, y=stevilo), color="red") +
  scale_x_continuous(breaks =  seq(2008,2022, 3))
