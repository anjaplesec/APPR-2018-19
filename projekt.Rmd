...
```{r rstudio, echo=FALSE, results='asis', fig.align='center', fig.cap=''}
...
```{r uvoz, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap=''}
...
3. `trajanje_iskanje_dela` - podatki o brezposelnosti po trajanju iskanja dela v Sloveniji,
   - `trajanje` - spremenljivka: pove nam, koliko časa brezposelna oseba išče delo,
   - `spol` - spremenljivka: spol brezposelnega,
   - `leta` - spremenljivka: pove nam, katero leto opazujemo,
   - `stevilo` - meritev: pove nam število brezposelnih(x1000), glede na to kako dolgo si brezposelna oseba že išče delo.

4. `tip_gospodinjstva` - podatki o trajnaju brezposelnosti glede na tip gospodinjstva v Sloveniji,
   - `leto` - spremenljivka: pove nam, katero leto opazujemo,
...
7. `obcine` - podatki o brezposelnosti v posameznih slovenskih občinah,
...
```{r vizualizacija, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.align='center', fig.cap=''}
...
```{r graf1, echo=FALSE, fig.align='center',warning=FALSE, fig.align='center', fig.cap=''}
...
```{r graf2, echo=FALSE, fig.align='center', warning=FALSE, fig.align='center', fig.cap=''}
...
```{r graf3, echo=FALSE, fig.align='center', warning=FALSE}
...
```{r zemljevid1, echo=FALSE, fig.align='center', warning=FALSE, fig.align='center', fig.cap=''}
...
Iz zemljevida lahko razberemo, da je največ brezposelnih v Grčiji in v Španiji. Slovenija je država, ki ima malo brezposelnih ljudi, vendar se vseeno ne more primerjati z Nemčijo ali Španijo.
```{r zemljevid2, echo=FALSE, fig.align='center', warning=FALSE, fig.align='center', fig.cap=''}
...
```{r skupaj, echo=FALSE, message=FALSE, fig.align='center', fig.cap=''}
print(skupaj)
```
...
```{r shiny, echo=FALSE,fig.align='center', fig.cap=''}
