...
1. `brezposelnost_izobrazba` - podatki o brezposelnosti glede na izobrazbo v Sloveniji
   ...
   - `stevilo` - meritev: pove nam število brezposelnih oseb pri določeni izobrazbi(v 1000).
...
2. `vsi_brezposelni` - podatki o brezposelnosti glede na starost in spol v Sloveniji,
   ...
   - `stevilo` - meritev: pove nam število brezposelnih glede na spol in leto(v 1000).
...
3. `trajanje_iskanje_dela` - podatki o brezposelnosti po trajanju iskanja dela v Sloveniji,
   ...
   - `leta` - spremenljivka: pove nam, katero leto opazujemo,
   - `stevilo` - meritev: pove nam število brezposelnih(v 1000), glede na to kako dolgo si brezposelna oseba že išče delo.
